...
#define MAP_OPCODES                                         \
    ...
    ON_OPCODE_IDENTIFIER(OP_PUSH0, push0)                   \
                                                            \
    ON_OPCODE_IDENTIFIER(OP_PUSH1, push)                    \
    ON_OPCODE_IDENTIFIER(OP_PUSH2, push)                    \
    ON_OPCODE_IDENTIFIER(OP_PUSH3, push)                    \
    ON_OPCODE_IDENTIFIER(OP_PUSH4, push)                    \
    ON_OPCODE_IDENTIFIER(OP_PUSH5, push)                    \
    ON_OPCODE_IDENTIFIER(OP_PUSH6, push)                    \
    ON_OPCODE_IDENTIFIER(OP_PUSH7, push)                    \
    ON_OPCODE_IDENTIFIER(OP_PUSH8, push)                    \
    ON_OPCODE_IDENTIFIER(OP_PUSH9, push)                    \
    ON_OPCODE_IDENTIFIER(OP_PUSH10, push)                   \
    ON_OPCODE_IDENTIFIER(OP_PUSH11, push)                   \
    ON_OPCODE_IDENTIFIER(OP_PUSH12, push)                   \
    ON_OPCODE_IDENTIFIER(OP_PUSH13, push)                   \
    ON_OPCODE_IDENTIFIER(OP_PUSH14, push)                   \
    ON_OPCODE_IDENTIFIER(OP_PUSH15, push)                   \
                                                            \
    ON_OPCODE_IDENTIFIER(OP_PUSH16, push)                   \
    ON_OPCODE_IDENTIFIER(OP_PUSH17, push)                   \
    ON_OPCODE_IDENTIFIER(OP_PUSH18, push)                   \
    ON_OPCODE_IDENTIFIER(OP_PUSH19, push)                   \
    ON_OPCODE_IDENTIFIER(OP_PUSH20, push)                   \
    ON_OPCODE_IDENTIFIER(OP_PUSH21, push)                   \
    ON_OPCODE_IDENTIFIER(OP_PUSH22, push)                   \
    ON_OPCODE_IDENTIFIER(OP_PUSH23, push)                   \
    ON_OPCODE_IDENTIFIER(OP_PUSH24, push)                   \
    ON_OPCODE_IDENTIFIER(OP_PUSH25, push)                   \
    ON_OPCODE_IDENTIFIER(OP_PUSH26, push)                   \
    ON_OPCODE_IDENTIFIER(OP_PUSH27, push)                   \
    ON_OPCODE_IDENTIFIER(OP_PUSH28, push)                   \
    ON_OPCODE_IDENTIFIER(OP_PUSH29, push)                   \
    ON_OPCODE_IDENTIFIER(OP_PUSH30, push)                   \
    ON_OPCODE_IDENTIFIER(OP_PUSH31, push)                   \
    ON_OPCODE_IDENTIFIER(OP_PUSH32, push)                   \
                                                            \
